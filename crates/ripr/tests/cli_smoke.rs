Warning: truncated output (original token count: 108229)
Total output lines: 11385
...
-> Result<(), Box<dyn std::error::Error>> {
    ...
    // — the descendant shape is reachable, not always lineage-rejected.
...
#[test]
fn agent_receipt_rejects_tampered_pair_binding_fields() -> R…8229 tokens truncated…("Analysis mode default: draft"));
