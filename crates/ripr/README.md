...
| --- | --- | --- |
| Distribution | `0.10.0` is the current development version of the Rust crate; no published public release exists yet (the `0.8.0`, `0.9.0`, and `0.10.0` GitHub Releases are all unpublished drafts as of 2026-07-21). `ripr-swarm` remains the development trunk; source `ripr` remains the release/distribution authority. Rust 1.95 MSRV. | Promotion and release-maintenance proof. |
