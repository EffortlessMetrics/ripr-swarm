...
/// seen only through a local (`result`), in a weak assertion, or in a call to a
/// different function does not witness the boundary.
#[test]
...
-> Result<(), String> {
    ...
    let cases = [
        vec![exact_value_test("shippingFee", "result", "0")],
        vec![
            exact_value_test("shippingFee", "shippingFee(60)", "0"),
            weak_at_boundary,
        ],
