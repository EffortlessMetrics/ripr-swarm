...
mod tests {
    ...
    fn help_flags_are_consistent_for_key_commands() {
        ...
        let commands: &[(&str, &str, &[&str])] = &[
            ...
            ("pr-summary", PR_SUMMARY_HELP, &["--check", "--baseline"]),
            (
                "annotations",
                ANNOTATIONS_HELP,
                &["--comments", "--out", "--check"],
            ...
            (
                "pr-evidence",
                PR_EVIDENCE_HELP,
                &["--root", "--base", "--head", "--check"],
            ),
            (
                "impacted-evidence",
                IMPACTED_EVIDENCE_HELP,
                &["--pr-evidence", "--label", "--labels", "--check"],
            ),
            (
                "plus",
                PLUS_HELP,
                &["--check", "--gap-ledger", "--repo-exposure-summary"],
            ),
        ];
