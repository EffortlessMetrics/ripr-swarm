...
#[cfg(test)]
use crate::cli::commands_agent_support::resolve_agent_brief_working_set;
...
#[cfg(test)]
use self::agent_command::render_agent_packet_from_gap_ledger;
#[cfg(test)]
use self::init_command::{generated_github_actions_workflow, parse_options as parse_init_options};

pub(super) fn agent(args: &[String]) -> Result<(), String> {
    agent_command::run(args)
}
