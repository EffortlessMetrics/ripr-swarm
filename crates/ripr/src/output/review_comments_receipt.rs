...
impl ReviewCommentsRunReceipt {
    ...
    #[allow(dead_code, reason = "terminal transition is wired by the follow-up deadline orchestration slice")]
    ...
    #[allow(dead_code, reason = "terminal transition is wired by the follow-up error orchestration slice")]
