...
pub(crate) fn execute(command: XtaskCommand) -> Result<(), String> {
    match command {
        ...
        XtaskCommand::ReleaseServerArchive(args) => super::reports::release_server::release_server_archive(&args),
        XtaskCommand::ReleaseServerManifest(args) => super::reports::release_server::release_server_manifest(&args),
        XtaskCommand::ReleaseUploadAssets(args) => super::reports::release_server::release_upload_assets(&args),
