...
/// lines, and the gates that were never invoked.
...
/// is responsible for making that state explicit.
...
/// gates that were never run, and never carries a `Status: pass` line.
