...
Linked ADRs: n/a
Active goal: `cross-language-evidence-router-ux`;
`.ripr/goals/active.toml` currently leaves
`output/bun-ub-preview-summary` ready
...
The patch proof packet for that closed path is recorded in
`docs/handoffs/2026-06-05-typescript-bun-preview-patch-proof.md`. The next
implementation slice is `output/bun-ub-preview-summary`.
