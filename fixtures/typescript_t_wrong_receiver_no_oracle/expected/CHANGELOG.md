...
Reason:
pin TypeScript execution-context wrong-receiver non-oracle guard
...
## Pending — typescript_t_wrong_receiver_no_oracle (2)
...
## Pending — typescript_t_wrong_receiver_no_oracle (3)
