...
Reason:
pin TypeScript Jest/Vitest describe, each, and weak-oracle assertion facts
...
## Pending — typescript_jest_vitest_assertion_facts (2)
...
## Pending — typescript_jest_vitest_assertion_facts (3)
