...
dynamic-dispatch, decorator-indirection, missing-import-graph, mocked-module,
opaque-custom-helper, property-based, and unresolved-fixture no-action examples
before any broader support-tier discussion treats these limits as measured
