...
Reason:
RIPR-SPEC-0028: pin mixed-language no-cross-route Python preview behavior
...
## Pending — python_mixed_language_no_cross_route (2)
...
## Pending — python_mixed_language_no_cross_route (3)
