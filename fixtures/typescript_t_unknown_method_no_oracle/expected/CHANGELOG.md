...
Reason:
pin TypeScript execution-context unknown-method non-oracle guard
...
## Pending — typescript_t_unknown_method_no_oracle (2)
...
## Pending — typescript_t_unknown_method_no_oracle (3)
