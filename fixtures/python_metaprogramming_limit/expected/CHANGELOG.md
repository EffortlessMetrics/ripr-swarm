...
Reason:
Add Python static-limit fixture

Command:
`cargo xtask goldens bless python_metaprogramming_limit --reason "..."`
...
## Pending — python_metaprogramming_limit (2)
...
## Pending — python_metaprogramming_limit (3)
