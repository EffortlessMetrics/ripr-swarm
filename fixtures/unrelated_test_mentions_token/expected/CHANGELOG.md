...
Reason:
RIPR-SPEC-0002: unrelated token mentions must not establish reachability
...
Reason:
RIPR-SPEC-0147: retain expected check output while publishing typed analysis outcome.
...
## Pending — unrelated_test_mentions_token (2)
...
## Pending — unrelated_test_mentions_token (3)
