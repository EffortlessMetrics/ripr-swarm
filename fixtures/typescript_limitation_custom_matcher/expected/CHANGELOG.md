...
Reason:
initial golden for typescript_custom_matcher_unresolved named limitation (RIPR-SPEC-0085 PR4)
...
## Pending — typescript_limitation_custom_matcher (2)
...
## Pending — typescript_limitation_custom_matcher (3)
