...
**seed schema**, not an accuracy result and not a judging engine.
...
The selected panel must therefore contain all three directions:
...
The issue’s subsequent PRs should:
...
No analyzer change, no automated judgment, no mutation execution, no provider
call, no generated test, no repair assignment, and no support-tier promotion
is made by this seed.
