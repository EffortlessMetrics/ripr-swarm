...
Reason:
Pin Python same-line duplicate collapse for returned dict repair routing.
...
## Pending — python_same_line_duplicate_collapse (2)
...
## Pending — python_same_line_duplicate_collapse (3)
