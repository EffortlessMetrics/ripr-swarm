...
Reason:
Python repair classes v1 pins returned-dict field missing discriminator guidance.
...
## Pending — python_dict_field_repair_gap (2)
...
## Pending — python_dict_field_repair_gap (3)
