...
Reason:
767: new fixture pinning Exposed gradient via expect(...).toBe(...)
...
## Pending — typescript_strong_oracle (2)
...
## Pending — typescript_strong_oracle (3)
...
## Pending — typescript_strong_oracle (4)
