...
- Receipt: receipt_missing (fixtures/boundary_gap/expected/pr-review-front-panel/stale-same-path-receipt/agent-receipt.json)
...
- Receipt: fixtures/boundary_gap/expected/pr-review-front-panel/stale-same-path-receipt/agent-receipt.json

Artifacts:
- Start here: fixtures/boundary_gap/expected/pr-review-front-panel/stale-same-path-receipt/pr-review-front-panel.md
