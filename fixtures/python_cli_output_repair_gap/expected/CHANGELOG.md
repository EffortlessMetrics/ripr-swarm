...
Reason:
Add Click CLI output repair-card fixture
...
Reason:
Specialize Python CLI output repair-card copy
...
## Pending — python_cli_output_repair_gap (2)
...
## Pending — python_cli_output_repair_gap (3)
