...
Reason:
PR #2270 review (thread ZR): rename misleading test title; classifications unchanged
...
## Pending — typescript_adversarial_same_method_other_class (2)
...
## Pending — typescript_adversarial_same_method_other_class (3)
