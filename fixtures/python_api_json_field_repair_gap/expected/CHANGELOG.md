...
Reason:
add API JSON-field repair-card fixture

Command:
`cargo xtask goldens bless python_api_json_field_repair_gap --reason "..."`
...
Reason:
sharpen python API JSON field repair assertion shape
...
## Pending — python_api_json_field_repair_gap (2)
...
## Pending — python_api_json_field_repair_gap (3)
