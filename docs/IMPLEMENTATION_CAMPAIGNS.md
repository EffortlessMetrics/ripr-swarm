...
| `docs/spec-config-policy-unsupported-flow-expansion` | done | [swarm #241](https://github.com/EffortlessMetrics/ripr-swarm/issues/241) / [source #1142](https://github.com/EffortlessMetrics/ripr/issues/1142) refines unsupported-flow expansion criteria for existing config/policy evidence. |
| `fixtures/config-policy-unsupported-flow-burndown` | done | [swarm #246](https://github.com/EffortlessMetrics/ripr-swarm/issues/246) / [source #1143](https://github.com/EffortlessMetrics/ripr/issues/1143) pins selected config/policy unsupported-flow cases before analyzer work. |
| `analysis/config-policy-unsupported-flow-support` | done | [swarm #250](https://github.com/EffortlessMetrics/ripr-swarm/issues/250) / [source #1144](https://github.com/EffortlessMetrics/ripr/issues/1144) expands one selected unsupported-flow category only when fixture-backed. |
| `analysis/actionable-repair-route-completeness` | ready | [swarm #254](https://github.com/EffortlessMetrics/ripr-swarm/issues/254) / [source #1145](https://github.com/EffortlessMetrics/ripr/issues/1145) keeps actionable canonical items repair-routed. |
