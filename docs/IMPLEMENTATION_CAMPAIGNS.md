...
| `dogfood/finding-alignment-examples-refresh` | done | [swarm #267](https://github.com/EffortlessMetrics/ripr-swarm/issues/267) / [source #1149](https://github.com/EffortlessMetrics/ripr/issues/1149) refreshes examples only after material burn-down deltas; dogfood receipts now include canonical gap identity where applicable, raw finding summaries, repair or no-action routes, before/after context, and the fixture-backed opaque report lookup actionable delta. |
