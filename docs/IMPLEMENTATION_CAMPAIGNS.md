...
| `campaign/actionable-surface-translation-closeout` | done | Closed the campaign after the badge, PR, editor, swarm, and outcome/trend surfaces proved the first-screen translation contract and recorded the remaining advisory/static limits. |
...
- [Actionable Surface Translation closeout](handoffs/2026-05-23-actionable-surface-translation-closeout.md)
  records the PR chain, validation, claim boundary, remaining limits, and
  no-successor active-goal state.
