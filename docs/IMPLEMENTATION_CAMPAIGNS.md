...
| `analysis/actionable-repair-route-completeness` | ready | [#1145](https://github.com/EffortlessMetrics/ripr/issues/1145) keeps actionable canonical items repair-routed. |
