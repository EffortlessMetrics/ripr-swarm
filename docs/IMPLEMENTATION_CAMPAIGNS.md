...
| `analysis/top-static-limitation-bucket-burndown` | ready | [swarm #238](https://github.com/EffortlessMetrics/ripr-swarm/issues/238) / [source #1159](https://github.com/EffortlessMetrics/ripr/issues/1159) burns down the current audit-selected `call_presence` / `activation_owner_call_unresolved` bucket with fixture-backed analyzer repair. |
