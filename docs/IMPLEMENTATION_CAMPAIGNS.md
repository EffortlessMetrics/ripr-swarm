...
| `docs/canonical-alignment-contract-refresh` | done | [swarm #274](https://github.com/EffortlessMetrics/ripr-swarm/issues/274) / [source #1153](https://github.com/EffortlessMetrics/ripr/issues/1153) refreshed the v2 downstream handoff with dogfood receipt fields, supported opaque report lookup guidance, actionable scorecard/trend lead context, and runtime static-only calibration boundaries. |
