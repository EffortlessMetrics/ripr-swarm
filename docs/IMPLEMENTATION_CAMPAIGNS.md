...
| `report/actionable-canonical-gaps-scorecard-lead` | done | [swarm #262](https://github.com/EffortlessMetrics/ripr-swarm/issues/262) / [source #1147](https://github.com/EffortlessMetrics/ripr/issues/1147) landed in swarm #266; evidence-quality trend output now leads with actionable canonical gaps, maps the new Lane 1 metric into capability metadata, and keeps raw finding, canonical-item, repair-route, and verify-command metrics visible. |
...
| `dogfood/finding-alignment-examples-refresh` | ready | [swarm #267](https://github.com/EffortlessMetrics/ripr-swarm/issues/267) / [source #1149](https://github.com/EffortlessMetrics/ripr/issues/1149) refreshes examples only after material burn-down deltas. |
