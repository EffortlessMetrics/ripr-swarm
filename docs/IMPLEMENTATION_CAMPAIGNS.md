...
| `outcome/reviewer-native-receipts` | done | `ripr outcome` receipts now include a reviewer-native review receipt that explains what changed, what RIPR flagged before, which focused proof signals moved, what remains weak or unknown, and what reviewers should inspect or avoid inferring. |
