...
| `cli/start-here-command-language` | done | #203 made the CLI front-door and `start-here` alias print the converged safe-next-action, verification, receipt, recovery-state, and advisory-boundary language without changing packet schema. |
