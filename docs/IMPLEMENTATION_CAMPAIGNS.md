...
| `cli/first-pr-front-door-polish` | done | Made `ripr first-pr` explain the selected repair context or recovery state in the CLI and Markdown first screen after the goal-freshness guardrail. |
