...
| `campaign/cross-language-oracle-graph-closeout` | ready | Close the #910/#908 campaign with issue state, claim boundaries, validation evidence, remaining non-claims, and no successor unless current repo-owned state selects one. |
