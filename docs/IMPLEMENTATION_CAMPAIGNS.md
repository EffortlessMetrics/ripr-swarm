...
| `report/value-resolution-audit-delta` | ready | Record before/after Lane 1 audit, scorecard, and trend movement for the selected bucket, including any zero-movement result. |
