...
| `analysis/actionable-repair-route-completeness` | done | [swarm #254](https://github.com/EffortlessMetrics/ripr-swarm/issues/254) / [source #1145](https://github.com/EffortlessMetrics/ripr/issues/1145) landed in swarm #257; config/policy repair-route coverage now requires top-level structured `repair_route` evidence instead of prose or class-local metadata. |
| `analysis/actionable-verify-command-coverage` | ready | [swarm #258](https://github.com/EffortlessMetrics/ripr-swarm/issues/258) / [source #1146](https://github.com/EffortlessMetrics/ripr/issues/1146) keeps actionable canonical items verifiable where feasible. |
