...
| `outcome/movement-front-section` | done | Actionable-gap outcomes now lead with receipt-linked movement: actionable total, known delta, resolved, improved, unchanged, orphaned/missing receipts, and top blocked reason. |
