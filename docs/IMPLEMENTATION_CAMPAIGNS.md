...
| `calibration/runtime-confidence-coverage-audit` | ready | [#1160](https://github.com/EffortlessMetrics/ripr/issues/1160) reports calibrated-supported versus static-only canonical items by class. |
