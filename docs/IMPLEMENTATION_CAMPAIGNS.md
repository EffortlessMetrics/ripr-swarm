...
| `analysis/top-static-limitation-bucket-burndown` | done | [swarm #238](https://github.com/EffortlessMetrics/ripr-swarm/issues/238) / [source #1159](https://github.com/EffortlessMetrics/ripr/issues/1159) turns the top named static limitation bucket into fixture-backed analyzer repair. |
| `docs/spec-config-policy-unsupported-flow-expansion` | ready | [swarm #241](https://github.com/EffortlessMetrics/ripr-swarm/issues/241) / [source #1142](https://github.com/EffortlessMetrics/ripr/issues/1142) refines unsupported-flow expansion criteria for existing config/policy evidence. |
