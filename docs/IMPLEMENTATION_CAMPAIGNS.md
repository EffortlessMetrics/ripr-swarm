...
| `surfaces/one-screen-loop-convergence` | done | Generated CI, VS Code/editor handoff, PR front-panel, and agent packet surfaces now mirror the same first-useful-pr wording and repair unit. |
