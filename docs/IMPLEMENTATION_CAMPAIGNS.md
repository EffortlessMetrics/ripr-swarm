...
| `release/supplemental-denominator` | in progress | #2768 / PR #2790 merged the fail-closed ledger validator and the current-main refresh now records 230 first-parent commits through `fcbb30a`. PRs #2842 and #2844 plus corrective #2858/#2859/#2862, release-control #2857, corrective #2867, and follow-ups #2870, #2860, #2861, and #2869 are present in development history with current `safe_defer_post_0_11` disposition and `absent_by_candidate_only_exclusion` tree state; earlier `hold_post_release` is historical context, while #2840/#2841 remain partial. Any later corrective commits for those lanes inherit the same disposition unless #2379 explicitly changes the release graph; the ledger remains provisional and does not unblock #1609. |
