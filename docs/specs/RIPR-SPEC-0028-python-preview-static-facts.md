...
see the activating input either way: the oracle verdict stands and an `exposed`
finding carries a `boundary_activation_unresolved` evidence line naming that
limitation.
