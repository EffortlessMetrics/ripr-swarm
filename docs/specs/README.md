...
| [RIPR-SPEC-0099](RIPR-SPEC-0099-lsp-related-test-codelens.md) | accepted | LSP advisory codeLens above changed symbols citing the cached related-test count; display-only, never a gate; honesty rules: snapshot==None→empty, N==0→"no related tests found", preview prefix for TS/Python |
