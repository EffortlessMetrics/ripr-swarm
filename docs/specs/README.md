...
| [RIPR-SPEC-0151](RIPR-SPEC-0151-source-currentness.md) | proposed | Finding source currentness: producer-owned per-finding disposition (`candidate_current`, `base_deleted`, `moved_or_renamed`, `unresolved_subject`) resolving which revision owns the actionable source; removed-only Rust probes record the base-side coordinate, ids stay content-addressed, and no gate or actionability policy changes in this slice (#3280) |
