...
| [RIPR-SPEC-0129](RIPR-SPEC-0129-editor-integration-contract.md) | accepted | Three-layer editor integration contract (standard LSP, enhanced VS Code, headless riprAgent) and support matrix |
