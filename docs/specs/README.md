...
| [RIPR-SPEC-0156](RIPR-SPEC-0156-currentness-editor-projection.md) | proposed | Currentness editor projection and qualification corpus: code lenses gate on candidate actionability so base-deleted evidence is never pinned at its projected coordinate; a three-fixture corpus pins deleted-tail, reused-coordinate identity, and movement-without-evidence end to end (#3282) |
