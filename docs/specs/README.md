...
| [RIPR-SPEC-0114](RIPR-SPEC-0114-rust-transitive-reach-limitation.md) | accepted | Rust transitive-reach limitation (P3 slice-a): when no_static_path has no related tests but a bounded BFS walk (depth<=3) finds a candidate path test->...->owner, name the limitation as static_limit_kind=rust_transitive_reach_unresolved; fail-closed (no promotion, 'may' language, stops at macros/externals/depth>3) |
