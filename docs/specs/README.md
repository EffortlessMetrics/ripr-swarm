...
| [RIPR-SPEC-0144](RIPR-SPEC-0144-release-control-lens.md) | accepted | Temporary 0.11 release-control lens: deterministic captured-input PR dispositions, current-authority reconciliation, and fail-closed merge eligibility without issue, branch, merge, or publication mutation (#2766) |
| [RIPR-SPEC-0145](RIPR-SPEC-0145-release-execution-scope.md) | accepted | Candidate-only 0.11 execution-surface disposition: verify the complete #2396 exclusion against the current parent while preserving development history and the release non-claim (#2767) |
| [RIPR-SPEC-0146](RIPR-SPEC-0146-release-denominator.md) | accepted | Supplemental 0.11 denominator ledger: preserve the ordered candidate range, reviewed dispositions, and fail-closed reconciliation without qualifying or publishing a candidate (#2768) |
