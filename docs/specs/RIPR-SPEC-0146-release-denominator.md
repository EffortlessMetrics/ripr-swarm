...
under `RIPR-SPEC-0146`. Focused proof is provided by the twenty-one tests named there
...
The twenty-one focused tests listed in `.ripr/traceability.toml` cover deterministic
...
references, malformed reference evidence, and the historical current-main census.
