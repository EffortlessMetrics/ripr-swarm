...
under `RIPR-SPEC-0146`. Focused proof is provided by the twenty tests named there
...
The twenty focused tests listed in `.ripr/traceability.toml` cover deterministic
