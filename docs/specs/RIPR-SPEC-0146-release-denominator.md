...
provisional census of `c86807ec..a8777c35` at `origin/main` as observed on
2026-08-01. It carries 223 first-parent records and 219 candidate-tree
records. The development-main merges for #2842, #2844, and corrective #2858
and #2859 are retained in
...
normalization test that pins its 223-record range and 219-record candidate-tree
count.
...
current-main 223-record census with the four candidate-only exclusions.
