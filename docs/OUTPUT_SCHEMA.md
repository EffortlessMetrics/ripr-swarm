...
routes with sample packet context, sample canonical gap IDs, sample source
locations, and non-claims so operators can inspect the backlog without treating
it as repair work. It is intentionally separate from
