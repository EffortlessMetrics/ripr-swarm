    ...
    "cases": [
      {
        ...
        "canonical_gap_id": "gap:dogfood:config-policy:rendered-label-observer",
        "raw_finding_summary": "Rendered label raw findings align into one output-observer gap.",
        "gap_state": "actionable",
        ...
        "repair_route": "add_report_render_config_output_snapshot_or_golden_observer",
        "no_action_reason": null,
        "verify_command": "cargo xtask evidence-quality-scorecard",
        "before_after_context": {
          "before": "Rendered config labels appeared as separate raw findings.",
          "after": "The canonical item records one actionable output-observer repair."
        },
