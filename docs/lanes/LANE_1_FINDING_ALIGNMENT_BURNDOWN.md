...
| 7 | [swarm #250](https://github.com/EffortlessMetrics/ripr-swarm/issues/250) / [source #1144](https://github.com/EffortlessMetrics/ripr/issues/1144) | `analysis/config-policy-unsupported-flow-support` | Move one selected config/policy unsupported-flow category out of limitation only when fixture-backed. | done via swarm #252; fixture-backed `opaque_config_lookup` moved out of limitation while unsupported lookup, macro-generated, dynamic-dispatch, and cross-file flows stayed named limitations |
| 8 | [#1145](https://github.com/EffortlessMetrics/ripr/issues/1145) | `analysis/actionable-repair-route-completeness` | Preserve the invariant that actionable canonical items always name a concrete repair route. | ready |
