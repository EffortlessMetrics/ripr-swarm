...
| 8 | [swarm #254](https://github.com/EffortlessMetrics/ripr-swarm/issues/254) / [source #1145](https://github.com/EffortlessMetrics/ripr/issues/1145) | `analysis/actionable-repair-route-completeness` | Preserve the invariant that actionable canonical items always name a concrete repair route. | done via swarm #257; config/policy repair-route coverage now requires top-level structured `repair_route` evidence instead of prose or class-local metadata |
| 9 | [swarm #258](https://github.com/EffortlessMetrics/ripr-swarm/issues/258) / [source #1146](https://github.com/EffortlessMetrics/ripr/issues/1146) | `analysis/actionable-verify-command-coverage` | Preserve and expand verification command coverage where feasible. | ready |
