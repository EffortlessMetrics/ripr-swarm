...
| TypeScript preview adapter readiness includes editor-projectable preview metadata, static limits, owner matching, oracle precision, and fixture evidence | `.ripr/goals/archive/2026-05-13-language-adapter-preview.toml`, #779, #780, #782, #785, #786 | Complete for current Campaign 27 routing readiness; #779, #780, #782, #785, and #786 are closed |
| Python preview adapter exists with editor-projectable preview metadata and static limits | `.ripr/goals/archive/2026-05-13-language-adapter-preview.toml`, #804, Python owner/test/assertion/probe/related-test/static-limit fixtures | Complete for current Campaign 27 routing readiness; preview output is opt-in, labeled, fixture-backed, and uses structured `static_limit_kind` values |
| `lsp/editor-language-routing` is ready or selected | `.ripr/goals/archive/2026-05-13-language-adapter-preview.toml` | Done; preview selectors landed behind `[languages]` while preserving Rust defaults |
