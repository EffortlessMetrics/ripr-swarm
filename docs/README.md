...
**New here?** Start with the [Quickstart](QUICKSTART.md) — install and first run in 5 minutes.

## Where to go next

| Goal | Start here |
|------|------------|
| **Get running fast** | [Quickstart](QUICKSTART.md) |
| **Understand the model** | [Documentation map](DOCUMENTATION.md) |
...
| **MCP client** | [MCP workspace status server](interop/mcp.md) |
...
- [Specs](specs/) — 170+ behavioral specifications
- [ADRs](adr/) — 22 architecture decision records
