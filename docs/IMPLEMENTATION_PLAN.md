...
`fixtures/bun-write-helper-gated-profile`, and
`analysis/configured-bridge-inventory` as completed selected slices. The
next implementation slice is `dogfood/live-bun-stable-byte-receipts`. The prior
