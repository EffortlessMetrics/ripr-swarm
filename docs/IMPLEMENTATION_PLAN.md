...
records `release/typescript-bun-preview-patch-proof` as the first selected
successor slice. This branch records that patch-proof packet and leaves
`output/bun-ub-preview-summary` as the next implementation slice. The prior
