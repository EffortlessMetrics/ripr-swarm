...
`fixtures/bun-write-helper-gated-profile` as completed selected slices. The
next implementation slice is `analysis/configured-bridge-inventory`. The prior
