...
attempted-without-receipt outcomes; the active queue resumes at
`report/route-quality-metrics` rather than redoing those closed trust-boundary
slices.
