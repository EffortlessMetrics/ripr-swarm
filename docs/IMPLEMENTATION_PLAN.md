...
leaves `release/typescript-bun-preview-patch-proof` ready as the first selected
successor slice. The prior post-release successor kept normal development in
