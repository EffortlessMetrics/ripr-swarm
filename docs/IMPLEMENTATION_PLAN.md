...
`fixtures/bun-node-fs-scalar-write-profile` as completed selected slices. The
next implementation slice is `fixtures/bun-write-helper-gated-profile`. The prior
