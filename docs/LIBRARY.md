...
| 2026-07-19 | `Result<_, String>` is the highest-leverage refactor target | [Result String](LEARNINGS.md#2026-07-19-result_-string-everywhere-is-the-single-highest-leverage-refactor-target) |
...
| 2026-07-19 | A gate does not gate when its blocking path is disconnected | [Gate Enforcement](LEARNINGS.md#2026-07-19-the-gate-does-not-gate--hardcoded-seam_id-breaks-the-blocking-path) |
...
| 2026-06-13 | Surface projection must reuse the shared renderer, not a parallel language renderer | [Surface Projection](LEARNINGS.md#2026-06-13-surface-projection-for-a-typescript-packet-goes-through-the-shared-renderer-not-a-parallel-ts-renderer-ripr-spec-0088) |
