...
| [Campaign records](../.ripr/goals/campaigns/) | Machine-readable durable campaign context. Use explicit `goals next --campaign <campaign-id>` for drill-down; live selection comes from current portfolio evidence. |
